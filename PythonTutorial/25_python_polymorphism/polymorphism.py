...
class Car(Vehicle):
    def move(self):
        print(f"Car brand {self.brand}, model {self.model} can Drive!")


class Boat(Vehicle):
    def move(self):
        print(f"Boat brand {self.brand}, model {self.model} can Sail!")


class Plane(Vehicle):
    def move(self):
        print(f"Plane brand {self.brand}, model {self.model} can Fly!")
