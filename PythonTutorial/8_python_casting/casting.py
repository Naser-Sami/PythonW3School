...
# Python is an object-orientated language, and as such it uses classes to define data type,
...
#   - float()   - construct a float number from an integer literal, a float literal or a string literal
